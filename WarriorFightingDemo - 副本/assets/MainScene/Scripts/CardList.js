...
cc.Class({
            ...
            //    cc.log(results);
                ...
                for(i = 0;i < results.cardData.length;i++) {
                    ...
                    if(loadScript.cardType === 1) {
                        ...
                        script2.speed = loadCreepCardScript.speed;
    ...
    renewShowCardGroup: function(){
        ...
        for(var i = 0;i<Global.userCard.length;i++) {
            this.showCardGroup(i, Global.userCard[i], 1);
        }
    ...
    sortCardGroupLayout: function(){
        var i = 0,j = 0;
        var pageNode = [];
        //for (i = 0; i < this.cardLayout.children.length; i++) {
        //
        //    //this.cardLayout.children[i].destroy();
        //    this.cardLayout.children[i].removeFromParent(true);
        //}
        this.cardLayout.removeAllChildren(true);
        //this.cardLayout.removeAllChildren(true);
        ...
        //for(j = 0 ;j < pageNum; j++){
            ...
            //nodeData.removeAllChildren(true);
        //cc.log(j);
            //if(j === 1){
        ...
        //pageNode[j].removeAllChildren(true);
        for (i = j * 9; i < this.cardGroup.length && i < j * 9 + 9; i++) {
            //cc.log(this.cardGroup[i]);
            this.cardGroup[i].parent = null;
            pageNode.addChild(this.cardGroup[i]);
        }

        this.cardLayout.addChild(pageNode);
        //j = this.nowPage;
        //var nodeData = pageNode[j];
    ...
    nextCardPage: function(){
        if(this.nowPage < Math.ceil(this.cardGroup.length / 9) - 1)this.nowPage++;
        this.sortCardGroupLayout();
    },
    //上一页
    lastCardPage: function(){
